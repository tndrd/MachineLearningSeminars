...
Обьявления
==========
1. Теллеграмм группа с правилами игры: `тык <https://t.me/+-3UJXdA4yLZjMWI6>`_.
...
Первое задание:
************************************************
- Начало: 20:00 22.09.2025.
- Сдавать лично в течении семестра, в конце семинара. Первая задача без штрафа до 13.10.2025, далее за половину баллов.
...
Второе задание:
************************************************
- Начало: 20:00 06.10.2025.
- Сдавать лично в течении семестра, в конце семинара. Первая задача без штрафа до 27.10.2025, далее за половину баллов.
- `Ссылка <https://www.kaggle.com/competitions/fall-ml-2-mipt-2025>`_
- Требуется: выбить максимальный балл на заданной выборке.

Третья задание:
************************************************
- Начало: 20:00 03.11.2025.
- Сдавать лично в течении семестра, в конце семинара. Первая задача без штрафа до 24.11.2025, далее за половину баллов.
- `Генератор задания <https://github.com/andriygav/MachineLearningSeminars/blob/master/hometask/task1-3/generator.ipynb>`_:
    - В качестве почты нужно ввести почту в домене @phystech.edu.
    - После ввода почты, вам будет предложена выборка с ссылкой для скачивания, а также методы, которые нужно проанализировать для данной выборки.
- Требуется:
    - Провести анализ выборки:
